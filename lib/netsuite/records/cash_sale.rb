module NetSuite
  module Records
    class CashSale
      ...
      fields :alt_handling_cost, :alt_shipping_cost, :bill_address,
        :billing_schedule, :contrib_pct, :created_date, :created_from, :currency_name, :custom_field_list,
        :deferred_revenue, :discount_total, :discount_item, :discount_rate,
        :email, :end_date, :est_gross_profit, :est_gross_profit_percent, :exchange_rate,
        ...
        :lead_source, :linked_tracking_numbers, :location, :memo, :message, :message_sel, :opportunity,
        :other_ref_name, :partner, :partners_list, :rev_rec_end_date,
        :rev_rec_on_rev_commitment, :rev_rec_schedule, :rev_rec_start_date, :revenue_status,
        :sales_effective_date, :sales_group, :sales_rep, :sales_team_list, :ship_address, :ship_date, :ship_group_list,
      ...
      record_refs :account, :bill_address_list, :custom_form, :department, :entity, :klass, :posting_period, :ship_address_list
